...
#### Is the same port for HTTP and HTTPS proxy?  
Yes  
...
| --- | --- | --- | --- |
| tinyproxy | 9091 | HTTP/HTTPS Proxy port | Y |
## Documentation

[tinyproxy  Administrator Guide](https://support.websoft9.com/docs/tinyproxy)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [tinyproxy  Enterprise Support](https://apps.websoft9.com/tinyproxy) 
